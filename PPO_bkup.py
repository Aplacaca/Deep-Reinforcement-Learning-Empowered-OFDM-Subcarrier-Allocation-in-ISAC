...
def parse_args():
    ...
    parser.add_argument('--action-dim', type=int, default=4, help='Number of Sensing Users')
    parser.add_argument('--categorical-dim', type=int, default=8, help='Number of Communication Users')
...
class trainer(object):
    def __init__(self, args):
        ...
        # ENV init
        self.env = ISAC_BS(N=args.subcarrier_number, N_c=self.args.categorical_dim, N_r=self.args.action_dim, seed=args.seed)
